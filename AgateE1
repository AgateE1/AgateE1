...
I'm now channelling that analytical mindset into a formal career in data. I am approaching the end of  Data Analytics course (at Turing Collage) , where I built skills in SQL, Excel, Python, Power BI, and I've been applying them to hands-on projects including A/B testing, Cohort Analysis, Funnel Analysis, Customer Value Analysis and more.
